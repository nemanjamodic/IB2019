...
import Lockbum.security.model.AuthenticationRequest;
import Lockbum.security.model.UserAuthenticationToken;
...
public class AuthenticationController {
	...
	public ResponseEntity<?> authenticateUser(@RequestBody AuthenticationRequest tokenRequest) throws AuthenticationException, IOException {
		UsernamePasswordAuthenticationToken authenticationRequest = new UsernamePasswordAuthenticationToken(tokenRequest.getEmail(), tokenRequest.getPassword());
